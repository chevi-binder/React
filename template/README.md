...
React Base Boilerplate - [Create React App](https://github.com/facebook/create-react-app) template based on [react-boilerplate-cra-template] (https://github.com/react-boilerplate/react-boilerplate-cra-template)
...
```shell
npx create-react-app --template cra-template-my-template my-app
```
